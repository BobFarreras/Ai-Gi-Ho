...
export function createTutorialArsenalMockData(playerId: string): ITutorialArsenalMockData {
  const cards = new Map<string, ICard>([
    ["tutorial-chatgpt", buildCard("tutorial-chatgpt", "ChatGPT", "ENTITY", 3, "/assets/renders/chatgpt.png", "Material de fusión 1. Debe combinarse con Gemini para habilitar GemGPT.", 1600, 1300)],
    ["tutorial-gemini", buildCard("tutorial-gemini", "Gemini", "ENTITY", 3, "/assets/renders/gemini.png", "Material de fusión 2. Junto con ChatGPT y la mágica adecuada activa la fusión GemGPT.", 1550, 1400)],
    ["tutorial-gemgpt-magic", buildCard("tutorial-gemgpt-magic", "Kernel de GemGPT", "EXECUTION", 4, "/assets/renders/docker.png", "Mágica de fusión específica: combina ChatGPT + Gemini para invocar GemGPT.")],
    ["tutorial-gemgpt-fusion", { ...buildCard("tutorial-gemgpt-fusion", "GemGPT", "FUSION", 7, "/assets/renders/gemgpt.png", "Carta de fusión final. Solo puede estar en Bloque de Fusión. Requiere ChatGPT + Gemini + Kernel de GemGPT.", 3000, 2500), fusionMaterials: ["tutorial-chatgpt", "tutorial-gemini"] }],
    ["mock-evolve-spark", buildCard("mock-evolve-spark", "Spark Adapter", "ENTITY", 2, "/assets/renders/vscode.png", "Carta tutorial de evolución. Cuando vibra en almacén tienes copias suficientes para subir de versión.", 1100, 1300)],
    ["mock-filler-1", buildCard("mock-filler-1", "CLI Scout", "ENTITY", 1, "/assets/renders/linux.png", "Carta de soporte para completar el deck de práctica a 20 cartas.", 900, 900)],
    ["mock-filler-2", buildCard("mock-filler-2", "Type Checker", "ENTITY", 2, "/assets/renders/python.png", "Carta de soporte de práctica para explicar orden y filtros del almacén.", 1400, 1000)],
