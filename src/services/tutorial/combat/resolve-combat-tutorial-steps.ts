...
export function resolveCombatTutorialSteps(): ITutorialFlowStep[] {
  return [
    ...
    {
      id: "combat-fusion-select-card",
      title: "Selecciona GemGPT",
      description: "Selecciona tu carta de fusión GemGPT para preparar el ataque directo.",
      targetId: "tutorial-board-player-entity-card-fusion-gemgpt",
      allowedTargetIds: ["tutorial-board-battlefield", "tutorial-board-player-entity-card-fusion-gemgpt"],
      completionType: "USER_ACTION",
      expectedActionId: "SELECT_FUSION_ENTITY_FOR_ATTACK",
    },
    {
      id: "combat-fusion-direct-attack",
      title: "Ataque de GemGPT",
      description: "Con GemGPT seleccionada, toca la zona rival resaltada para ejecutar el ataque directo.",
      targetId: "tutorial-board-opponent-zone-1",
      allowedTargetIds: ["tutorial-board-opponent-zone-1"],
      completionType: "USER_ACTION",
      expectedActionId: "PLAYER_FUSION_DIRECT_ATTACK_DONE",
    },
    {
      id: "combat-fusion-pass-turn",
      title: "Cerrar turno",
      description: "Pulsa Pasar para ceder turno. El rival responderá colocando una carta en defensa.",
      targetId: "tutorial-board-phase-pass-button",
      allowedTargetIds: ["tutorial-board-phase-controls", "tutorial-board-phase-pass-button"],
      completionType: "USER_ACTION",
