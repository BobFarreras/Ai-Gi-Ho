...
export const storyAct1MapDefinition: IStoryActMapDefinition = {
  ...
  nodes: [
    ...
    { id: "story-ch1-duel-3", unlockRequirementNodeId: "story-ch1-path-branch-2", position: { x: 2860, y: 1000 } },
  ...
  virtualNodes: [
    ...
    v({ id: "story-ch1-reward-card-elite", duelIndex: 101, nodeType: "REWARD_CARD", title: "Carta", rewardCardId: "trap-kernel-panic", unlockRequirementNodeId: "story-ch1-duel-3", position: { x: 3120, y: 1000 } }),
    v({ id: "story-ch1-path-lower-branch-nexus", duelIndex: 102, nodeType: "REWARD_NEXUS", title: "Moneda", rewardNexus: 280, unlockRequirementNodeId: "story-ch1-path-branch-2", position: { x: 2860, y: 1420 } }),
    v({ id: "story-ch1-path-lower-final-blank", duelIndex: 103, nodeType: "MOVE", title: "Tramo Final", unlockRequirementNodeId: "story-ch2-duel-3", position: { x: 3380, y: 1420 } }),
  ],
  platforms: [
    ...
    { id: "act1-p-14", position: { x: 2860, y: 1000 }, size: 170, style: "RUIN" },
    { id: "act1-p-15", position: { x: 3120, y: 1000 }, size: 170, style: "METAL" },
    { id: "act1-p-16", position: { x: 2860, y: 1420 }, size: 170, style: "RUIN" },
    { id: "act1-p-17", position: { x: 3120, y: 1420 }, size: 170, style: "METAL" },
    { id: "act1-p-18", position: { x: 3380, y: 1420 }, size: 170, style: "RUIN" },
    { id: "act1-p-19", position: { x: 3640, y: 1420 }, size: 170, style: "NEON" },
  ],
};
