...
export function TrainingArenaLobby(props: ITrainingArenaLobbyProps) {
  return (
    <section className="relative mx-auto flex min-h-screen w-full items-center justify-center overflow-hidden px-4 py-8 text-cyan-100">
      ...
      <div className="grid w-full max-w-5xl gap-2 rounded-xl border border-cyan-300/30 bg-slate-950/70 p-3 text-[11px] font-bold uppercase tracking-[0.08em] text-cyan-200 sm:grid-cols-2 md:grid-cols-4">
      ...
      <div className="grid w-full items-center gap-4 md:grid-cols-[1fr_auto_1fr] md:gap-8">
        <article className="rounded-2xl border border-cyan-300/35 bg-slate-950/80 p-4 shadow-[0_0_28px_rgba(34,211,238,0.2)]">
        ...
        <article className="rounded-2xl border border-rose-300/35 bg-slate-950/80 p-4 shadow-[0_0_28px_rgba(251,113,133,0.2)]">
