...
export function Battlefield({
  ...
  return (
    <motion.div 
      ...
      className="absolute inset-0 flex items-center justify-center cursor-grab active:cursor-grabbing perspective-[1200px]"
    >
      {/* El Tablero 3D Principal */}
      <div className="w-[900px] h-[700px] transform rotate-x-[50deg] scale-110 relative flex flex-col justify-center items-center gap-4 rounded-[3rem] border border-cyan-500/30 bg-zinc-950/80 p-8 shadow-[0_0_50px_rgba(6,182,212,0.15)] overflow-hidden">
        
        {/* EFECTO CYBERPUNK: Rejilla holográfica animada de fondo */}
        <div className="absolute inset-0 bg-[linear-gradient(to_right,#06b6d4_1px,transparent_1px),linear-gradient(to_bottom,#06b6d4_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_80%_80%_at_50%_50%,#000_20%,transparent_100%)] opacity-10 animate-[pulse_4s_ease-in-out_infinite]" />
        
        {/* EFECTO CYBERPUNK: Línea de escáner láser que baja por el tablero */}
        <div className="absolute top-0 left-0 w-full h-1 bg-cyan-400/50 shadow-[0_0_20px_rgba(34,211,238,1)] animate-[spin_10s_linear_infinite]" style={{ animation: 'scan 4s linear infinite' }}/>
