...
export function mockDefaultUseBoardReturn() {
  vi.mocked(useBoardModule.useBoard).mockReturnValue({
    ...
    lastEnergyTargetPlayerId: null,
    lastEnergyAmount: null,
    lastEnergyEventId: null,
    lastEnergyLossTargetPlayerId: null,
    lastEnergyLossAmount: null,
    lastEnergyLossEventId: null,
